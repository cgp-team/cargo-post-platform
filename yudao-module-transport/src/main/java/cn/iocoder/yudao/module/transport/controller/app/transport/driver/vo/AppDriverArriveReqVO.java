...
@Schema(description = "用户 APP - 司机到站 Request VO")
@Data
public class AppDriverArriveReqVO {
    ...
    @Schema(description = "到达站点编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
