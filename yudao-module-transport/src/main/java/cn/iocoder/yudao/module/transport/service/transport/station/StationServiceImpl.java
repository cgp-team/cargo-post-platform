...
public class StationServiceImpl implements StationService {
    ...
    // BE-16 备注：站点全量缓存已下线。StationDO 含 createTime/updateTime（LocalDateTime），
    // 与 monitoring/bigscreen 同类问题——本项目 Redis 缓存序列化器对含 LocalDateTime 的对象
    // 往返不可靠（已导致线上 500）。站点表数据量小，直接查库即可。
