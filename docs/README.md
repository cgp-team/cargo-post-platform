...
| 文档 | 内容 | 维护责任 |
|---|---|---|
| `requirements.md` | 需求基线与 P0/P1/P2 优先级（含实现现状标注） | 全员，以后端负责人为主 |
| `architecture.md` | 总体架构、模块边界、调用约束 | 后端负责人 |
| `database.md` | 数据库脚本与增量迁移说明 | 后端负责人 |
...
| `Git 协作.md` | 分支 + PR 协作流程（新人向） | 全员 |
| `upstream.md` | 上游 RuoYi-Vue-Pro 同步规则与基线 | 系统集成负责人 |
