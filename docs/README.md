...
| 文档 | 内容 |
|---|---|
| `requirements.md` | 需求基线与 P0/P1/P2 优先级（含实现现状标注） |
| `architecture.md` | 总体架构、模块边界、调用约束 |
...
| `upstream.md` | 上游 RuoYi-Vue-Pro 同步规则与基线 |

过程性工作记录（评审记录、审计报告、调研报告、回归证据等）归档在 [`internal/`](internal/)，仅作历史留存，不保证内容时效；其中的相对路径引用以移动前的位置为准。
